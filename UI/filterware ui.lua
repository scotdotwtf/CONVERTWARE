...
mainbar.Position = UDim2.new(0.5, -510, 0, -100)
mainbar.Size = UDim2.new(0, 1020, 0, 49)
mainbar.ZIndex = 0
...
input1.Position = UDim2.new(0.0145097915, 0, 0, 0)
input1.Size = UDim2.new(0.985490143, 0, 1, 0)
input1.ZIndex = 2
input1.Font = Enum.Font.Gotham
input1.PlaceholderColor3 = Color3.fromRGB(229, 229, 229)
input1.PlaceholderText = "command"
input1.Text = ""
input1.TextColor3 = Color3.fromRGB(229, 229, 229)
input1.TextSize = 26.000
...
predictframe.Position = UDim2.new(0.0149999997, 0, 0, 0)
predictframe.Size = UDim2.new(0.985000014, 0, 1, 0)
...
_0.Position = UDim2.new(-0.000375967444, 0, 0, 0)
_0.Size = UDim2.new(1.00037599, 0, 1, 0)
...
MainBarStroke.Color = Color3.fromRGB(93, 91, 93)
MainBarStroke.Thickness = 4
...
input1.FocusLost:Connect(function()
    mainbar:TweenPosition(UDim2.new(0.5, -510, 0, -100),"In","Quint",.3)
    input1:ReleaseFocus()
    wait(0.3)
    input1.Text = ""
    mainbar.Visible = false
...
UIS.InputBegan:Connect(function(input, gameProcessedEvent)
	if input.KeyCode == Enum.KeyCode.LeftAlt then
		if mainbar.Visible == false then
            ...
            input1:CaptureFocus()
            mainbar:TweenPosition(UDim2.new(0.5, -510,0, 50),"Out","Quint",.3)
        else
            mainbar:TweenPosition(UDim2.new(0.5, -510, 0, -100),"In","Quint",.3)
            input1:ReleaseFocus()
            wait(0.3)
...
function addcmd(CmdText)
    ...
    newcmd1.Position = UDim2.new(-0.000375967444, 0, 0, 0)
    newcmd1.Size = UDim2.new(1.00037599, 0, 1, 0)
    newcmd1.Font = Enum.Font.Gotham
    newcmd1.Text = CmdText
    newcmd1.TextColor3 = Color3.fromRGB(132, 132, 132)
    newcmd1.TextSize = 26.000
