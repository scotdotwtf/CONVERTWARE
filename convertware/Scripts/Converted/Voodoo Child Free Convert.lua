...
print(" > Running Voodoo Child Free by Creterisk")

game:GetService("Players").LocalPlayer.Character.InternationalFedora.Handle.SpecialMesh:Destroy()
...
print("when finishing this i was lazy lol -creterisk")
...
local dollh = alignchar['MeshPartAccessory']
local knifeh = alignchar['InternationalFedora']
...
dollh.Handle.AccessoryWeld:Destroy()
knifeh.Handle.AccessoryWeld:Destroy()

AlignCharacter(dollh.Handle,alignchar.Dummy.Dummy.Doll.Handle,Vector3.new(0,0,0),Vector3.new(0,45,0))
AlignCharacter(knifeh.Handle,alignchar.Dummy.Dummy.Needle.Handle2,Vector3.new(0,0,0),Vector3.new(45,0,0))
