...
print(" > Running Voodoo Child by Creterisk")
...
AlignCharacter(dollh.Handle,alignchar.Dummy.Dummy.Doll.Handle,Vector3.new(0,0,0.25),Vector3.new(0,180,0))
AlignCharacter(knifeh.Handle,alignchar.Dummy.Dummy.Needle.Handle2,Vector3.new(0,0.5,0),Vector3.new(0,90,90))
