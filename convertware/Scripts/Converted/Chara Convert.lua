...
print("> Running Chara by Nebula_Zorua")
...
function SoulSteal(whom,human)
	...
	if(torso and torso:IsA'BasePart' and alive == false)then
		whom:BreakJoints()
...
AlignCharacter(hhat.Handle,alignchar.Dummy.Dummy.Knife,Vector3.new(0,-0.25,0.1),Vector3.new(135,0,0))
