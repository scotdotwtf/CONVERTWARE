print("> Running Meme Animations by 123jl123? [idk]")
print([[- Controls (btw thank god spec exist cause he had to try ALL THESE KEYS)
9 > g/b toggle
T > Meme Dance/Song thing idk
F > Slap my hand [you'll have to reset to use this script again if you press f]
G then Q > Well...
G then E > MMM
G then T > that would be YOUR MOTHER!
G then Y > 😏
G then U > 🤢
G then P > 🎶🎶🎶🎶🎶
G then F > 🛑🛑🛑🚫⛔ STOP!!
G then Z > :3
G then X > AHHH
G then V > I really didn't 😢
G then B > because i can 😈
G then H > HMM MAYBEY????
B > l a z e r]])

loadstring(game:HttpGet('https://raw.githubusercontent.com/GelatekWasTaken/GelatekV2/main/LoadLibrary.lua',true))()

local model = game:GetService("Players").LocalPlayer.Character.Dummy.Dummy
