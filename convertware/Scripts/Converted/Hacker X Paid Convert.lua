...
print("> Running Hacker X by InfiniteOneWithdank")
...
>Ná´l : Ësn oÊ sÆuolÇq plÉ¹oÊ sá´É¥â´
ËnoÊ É¹oÉ Æuá´É¯oÉ ÇÉ¹,ÇÊ Ênq
ËËËÇÉ¯ puÉÊsÉ¹Çpun oÊ ÇlqÉ Çq Ê,uoÊ ÊlÉ¹ÉÇlÉ noâ
...
local hhat1 = alignchar['Pixel Rainbow Wings']
local hhat2 = alignchar['MagicStaffAccessory']
local hhat3 = alignchar['OverTheRainbowAccessory']
...
hhat1.Handle.AccessoryWeld:Destroy()
hhat2.Handle.AccessoryWeld:Destroy()
hhat3.Handle.AccessoryWeld:Destroy()

hhat1.Handle.SpecialMesh:Destroy()
hhat2.Handle.SpecialMesh:Destroy()
hhat3.Handle.SpecialMesh:Destroy()

AlignCharacter(hhat1.Handle,alignchar.Dummy.Dummy.s1,Vector3.new(0,0,-0.6),Vector3.new(0,0,0))
AlignCharacter(hhat2.Handle,alignchar.Dummy.Dummy.s2,Vector3.new(0,0,-0.54),Vector3.new(0,0,-90))
AlignCharacter(hhat3.Handle,alignchar.Dummy.Dummy.s3,Vector3.new(0,0,-0.53),Vector3.new(0,0,0))
...
function ScreenAway()
  ...
  Cso("1184953203", tors, 3, 1)
	for i = 0, 4, 0.1 do
		swait()
		Screen2.Transparency = Screen2.Transparency + 1
		Screen3.Transparency = Screen3.Transparency + 1
		Screen1.Transparency = Screen1.Transparency + 1
		rootj.C0 = clerp(rootj.C0, RootCF * CF(0* Player_Size, 0* Player_Size, -0.1 + 0.1* Player_Size * Cos(sine / 20)) * angles(Rad(0 - 4 * Sin(sine / 20)), Rad(0 + 1 * Cos(sine / 20)), Rad(-40)), 0.1)
		neck.C0 = clerp(tors.Neck.C0, necko* CF(0, 0, 0 + ((1* Player_Size) - 1)) * angles(Rad(0 - 5 * Sin(sine / 20)), Rad(0), Rad(40)), 0.1)
		rl.Weld.C0 = clerp(rl.Weld.C0, CF(0.5* Player_Size, -0.9 - 0.1 * Cos(sine / 20) - Rad(0 + 2 * Cos(sine / 20)) * Player_Size, 0* Player_Size) * angles(Rad(0 - 6 * Sin(sine / 20)), Rad(-10 + 1 * Cos(sine / 20)), Rad(0)) * angles(Rad(0), Rad(0), Rad(5 - 1 * Cos(sine / 20))), 0.1)
		ll.Weld.C0 = clerp(ll.Weld.C0, CF(-0.5* Player_Size, -0.9 - 0.1 * Cos(sine / 20) + Rad(0 + 2 * Cos(sine / 20)) * Player_Size, 0* Player_Size) * angles(Rad(0 - 6 * Sin(sine / 20)), Rad(10 + 1 * Cos(sine / 20)), Rad(0)) * angles(Rad(0), Rad(0), Rad(-5 - 1 * Cos(sine / 20))), 0.1)
