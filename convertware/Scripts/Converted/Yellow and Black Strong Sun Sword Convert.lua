...
--                vp.velocity=Character.Torso.CFrame.lookVector*Knockback
                ...
                if Humanoid.Health>100 and Character.Parent~=nil and TargHum.Health>100 and TargHum.Parent~=nil and Targetting==true then
                swait()
                end
...
AlignCharacter(hhat.Handle,Character.Model.Handle,Vector3.new(0,2.15,0),Vector3.new(0,0,-135))
...
function attackone()
        attack=true
        local con=Hitbox.Touched:connect(function(hit) Damagefunc(Hitbox,hit,0,0,math.random(0,0),"Normal",RootPart,.2,1) end) 
        for i=0,1,0.1 do
                swait()
...
print("--<< !! Yellow and Black Strong Sun Sword loaded!! >>--")
