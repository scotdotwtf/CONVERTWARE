...
print("> Running Linked Sword Remake by SezHu")
...
local hhat = alignchar['Void Sword']
...
AlignCharacter(hhat.Handle,alignchar.Dummy.Dummy.WeaponModel.SwordHandle,Vector3.new(-1,0.1,0),Vector3.new(45,60,0))

for _,v in pairs(alignchar.Dummy.Dummy.WeaponModel:GetChildren()) do
