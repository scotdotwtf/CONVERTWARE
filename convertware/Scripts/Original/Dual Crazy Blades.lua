--Blade throw fixed, other various fixes.

script.Name = "Ether Blades"
wait(0.05)
local Module_Id = 0
local Player = game:service("Players").XTheShowcaserX
repeat
  wait()
